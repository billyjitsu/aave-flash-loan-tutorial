...
async function main() {
  ...
  const daiContract = new hre.ethers.Contract(daiContractAddress, erc20Abi, wallet);
  const usdcContract = new hre.ethers.Contract(usdcContractAddress, erc20Abi, wallet);
